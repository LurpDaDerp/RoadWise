...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', marginBottom: height / (667 / 20) },
  title: { color: '#fff', fontSize: width / (375 / 28), fontWeight: '700', alignSelf: 'center' },
  lead: { color: '#f5f5f5', fontSize: width / (375 / 16), lineHeight: height / (667 / 22), marginBottom: height / (667 / 18) },
  ...
  statsTitle: { color: '#fff', fontSize: width / (375 / 18), fontWeight: '700', marginBottom: height / (667 / 8) },
  statLine: { color: '#e6e6e6', fontSize: width / (375 / 14), lineHeight: height / (667 / 20), marginBottom: height / (667 / 6) },
  statBold: { color: '#fff', fontWeight: '700' },
  personal: { color: '#e9e9e9', fontSize: width / (375 / 15), lineHeight: height / (667 / 22), marginBottom: height / (667 / 20) },
});
